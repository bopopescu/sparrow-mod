 ...
 */
public class SparrowProtoFrontend implements FrontendService.Iface {
  ...
  private static final Logger LOG = Logger.getLogger(SparrowProtoFrontend.class);
  ...
  public static void main(String[] args) {
    new SparrowProtoFrontend().run(args);
  }
}
