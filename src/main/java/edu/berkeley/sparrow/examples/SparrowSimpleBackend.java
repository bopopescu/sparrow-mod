 ...
 */
public class SparrowSimpleBackend implements BackendService.Iface {
  ...
  private static final Logger LOG = Logger.getLogger(SparrowSimpleBackend.class);
...
//      client.registerBackend(APP_ID, "localhost:" + listenPort);
  ...
  public static void main(String[] args) throws IOException, TException {
    ...
    SparrowSimpleBackend protoBackend = new SparrowSimpleBackend();
